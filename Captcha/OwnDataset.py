...
Original file is located at
    https://colab.research.google.com/drive/1IG4pS37ag38q4wbskTzUasz3--1u3Q4o
"""
...
# Non-configs
PATH = os.getcwd()
DATA_PATH = os.path.join(PATH, 'Subdatamap/Subdata')
...
#                     label[i*5+int(flr[i])] = 1
                ...
                img = cv2.resize(img, (int(150/2), int(40/2)), interpolation=cv2.INTER_AREA)
...
#    gen_dataset(DATA_PATH, 700*10 , NUM_OF_LETTERS, IMG_COLS, IMG_ROW)
...
! rm -rf "./Subdatamap/Subdata"

!unzip -qq "./Subdata.zip" -d "./Subdatamap"
